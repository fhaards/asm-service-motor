...
<head>
    ...
    <!-- <script src="<?= base_url() . 'vendor/twbs/bootstrap/dist/css/bootstrap.min.css'; ?>"></script> -->
...
<body class="az-body az-sidebar-hide <?= (isLogin() ? 'az-body-sidebar' : 'az-body-login'); ?>" onafterprint="clearPrint()" onbeforeprint="startPrint()">
    ...
    <script src="<?= base_url() . 'vendor/moment/moment/min/moment-with-locales.min.js'; ?>"></script>
    ...
    <script>
        $(function() {
            ...
            new PerfectScrollbar('.content-master', {
